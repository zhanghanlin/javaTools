package com.demo.java.utils.shell;
...
public class LinuxStateForShell {
    ...
    private static States disposeResultMessage(Map<String, String> result) {
        ...
        for (String command : COMMANDS) {
            ...
            if (command.equals(CPU_MEM_SHELL)) {
                ...
                //设置磁盘状态
                states.filesSystemStates = filesSystem;
            }
        }
        return states;
    }
    ...
    private static String disposeFilesSystem(String commandResult) {
        ...
        for (int i = 0; i < strings.length - 1; i++) {
            ...
            int temp = 0;
            String splitStr = "\\b";
            for (String s : strings[i].split(splitStr)) {
                if (temp == 0) {
                    temp++;
                    continue;
                }
    ...
    public static void main(String[] args) {
        Map<String, String> result = runDistanceShell(COMMANDS, "root", "P@ssw0rd", "192.168.106.122");
        //实体类
        final States states = disposeResultMessage(result);
        System.out.println(states);
        System.out.println(runLocalShell(COMMANDS));
    }
}
...
class States {
    ...
    private String filesSystemTotal;
    private String filesSystemFree;
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
                ...
                .add("filesSystemFree", filesSystemFree)
                .toString();
    }
}
